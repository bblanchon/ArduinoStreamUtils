...
[![Arduino Library Manager](https://img.shields.io/static/v1?label=Arduino&message=v1.6.1&logo=arduino&logoColor=white&color=blue)](https://www.ardu-badge.com/StreamUtils/1.6.1)
[![PlatformIO Registry](https://badges.registry.platformio.org/packages/bblanchon/library/StreamUtils.svg?version=1.6.1)](https://registry.platformio.org/packages/libraries/bblanchon/StreamUtils?version=1.6.1) 
